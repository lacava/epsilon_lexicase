...
\title{\edit{A probabilistic and multi-objective analysis of lexicase and $\epsilon$-lexicase selection}}  
...
\begin{algorithm}
    \caption{{\bf Static $\epsilon$-Lexicase Selection} applied to individuals $n \in \mathcal{N}$ with errors $e_t(n)$ and minimum error $e_t^*$ on training cases $t \in \mathcal{T}$.}\label{alg:ep-lex-s}
\noindent{\footnotesize
\begin{tabularx}{\textwidth}{lX}
...
\hspace{1em}	\textbf{for}	 $t \in \mathcal{T}$ and $n \in \mathcal{N}$:	&	define fitness $f$ using within-$\epsilon$ pass condition\\
...
\begin{algorithm}
\caption{{\bf Semi-dynamic $\epsilon$-Lexicase Selection} applied to individuals $n \in \mathcal{N}$ with errors $e_t(n)$ on training cases $t \in \mathcal{T}$.}\label{alg:ep-lex-sd}
\noindent{\footnotesize
\begin{tabularx}{\textwidth}{lX}
...
\begin{algorithm}
\caption{{\bf Dynamic $\epsilon$-Lexicase Selection} applied to individuals $n \in \mathcal{N}$ with errors $e_t(n)$ on training cases $t \in \mathcal{T}$.}\label{alg:ep-lex-d}
\noindent{\footnotesize
\begin{tabularx}{\textwidth}{lX}
